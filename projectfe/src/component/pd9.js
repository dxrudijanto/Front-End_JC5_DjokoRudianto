    ...
    <Navbar />
      ...
      <div className="container">
        <div className="col-lg-12 gp">
          <img width="50%" height="50%" className="img-responsive img-rounded center-block" alt="New Product1" src="img/p.labset.jpg" />
          <h3>Microscope, Laboratory, five lenses, appliances  </h3> <br />
          ...
          <div className="container">
            <div className="navH">
              <ul style={{marginRight: 85}}>
                <li className="gpt"> &nbsp;&nbsp;&nbsp; OS-2018-01-0034 &nbsp;&nbsp;&nbsp;</li>
                <li className="gpt"> &nbsp;&nbsp;&nbsp; USD 1500.75 &nbsp;&nbsp;&nbsp;</li>
