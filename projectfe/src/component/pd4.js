    ...
    <Navbar />
      ...
      <div className="container">
        <div className="col-lg-12 gp">
          <img width="50%" height="50%" className="img-responsive img-rounded center-block" alt="New Product1" src="img/p.drillbitset.jpg" />
          <h3>Drill, head sets, 12-15 mm, Carbon Steel </h3> <br />
          ...
          <div className="container">
            <div className="navH">
              <ul style={{marginRight: 85}}>
                <li className="gpt"> &nbsp;&nbsp;&nbsp; OS-2017-13-0401 &nbsp;&nbsp;&nbsp;</li>
                <li className="gpt"> &nbsp;&nbsp;&nbsp; USD 29.00 &nbsp;&nbsp;&nbsp;</li>
