    ...
    <Navbar />
      ...
      <div className="container">
        <div className="col-lg-12 gp">
          <img width="50%" height="50%" className="img-responsive img-rounded center-block" alt="New Product1" src="img/p.mbwood.jpg" />
          <h3>Pen, ink series, oakwood cured body, nos. 2231  </h3> <br />
          ...
          <div className="container">
            <div className="navH">
              <ul style={{marginRight: 85}}>
                <li className="gpt"> &nbsp;&nbsp;&nbsp; OS-2018-08-0099 &nbsp;&nbsp;&nbsp;</li>
                <li className="gpt"> &nbsp;&nbsp;&nbsp; USD 185.50 &nbsp;&nbsp;&nbsp;</li>
